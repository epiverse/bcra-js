...
- Author: Fanni Zhang
- Package: BCRA
- Version: 2.1.2 (2020-6-30)
- License: GPL (>= 2)
- Description: Provides risk projections of invasive breast cancer for women based on NCI's Breast Cancer Risk Assessment Tool (BCRAT)
